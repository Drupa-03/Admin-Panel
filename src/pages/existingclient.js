...
// import api from "@/utills/api"; // make sure path is correct
...
//       const toastKey = `${client.id}-${daysLeft}`;
//       if (!shownToastSet.has(toastKey)) {
//         shownToastSet.add(toastKey);
//         toast.warn(`${client.company_name}'s plan expires in 2 days!`, {
//           toastId: toastKey,
//           position: "top-right",
//           autoClose: 6000,
...
//               className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#004b8f]"
//             />
//           </div>
//         </div>
...
//               <thead className="dark:bg-gray-700 text-gray-700 dark:text-gray-200">
//                 <tr>
...
//                     (new Date(client.plan_end_date) - new Date()) / (1000 * 60 * 60 * 24)
//                   );
...
//                         isExpiringSoon
//                           ? 'bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 border-l-4 border-red-500 hover:shadow-lg'
...
//                           )}
//                           <span className={isExpiringSoon ? 'font-semibold text-red-700 dark:text-red-400' : ''}>
//                             {client.company_name}
//                           </span>
//                         </div>
//                       </td>
...
//                       <td className="px-4 py-3">
//                         {new Date(client.plan_start_date).toLocaleDateString("en-GB")}
//                       </td>
//                       <td className="px-4 py-3">
//                         <div className="flex items-center gap-2">
//                           <span className={isExpiringSoon ? 'font-semibold text-red-700 dark:text-red-400' : ''}>
//                             {new Date(client.plan_end_date).toLocaleDateString("en-GB")}
//                           </span>
//                         </div>
//                       </td>
//                       <td className="px-4 py-3">
...
//                           {is_update === 1 && (
//                             <button
//                               onClick={() => router.push(`/Add-client?id=${client.id}`)}
