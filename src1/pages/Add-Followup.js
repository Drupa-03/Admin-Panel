...
//     // Create preview for images, show icon for other file types
//     let previewUrl = null;
...
//             className='flex items-center gap-2 px-6 py-3 bg-[#004b8f] text-white rounded-xl hover:bg-[#003d73] transition-all duration-300 shadow-lg group'>
//             <ArrowLeft
//               size={18}
...
//                 {/* Image Preview using ReactModalImage */}
...
//                   </div>
//                 ) : (
//                   // Preview for other files: open in new tab
//                   <div
//                     onClick={() =>
//                       window.open(
...
//               className='flex items-center gap-2 px-8 py-3 bg-[#004b8f] text-white rounded-xl hover:bg-[#003d73] transition-all duration-300 shadow-lg disabled:opacity-70 disabled:cursor-not-allowed justify-center'>
