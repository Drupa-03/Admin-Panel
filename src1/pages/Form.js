...
import { Filter, Info, Send, Save } from "lucide-react";
...
export default function SocialPostForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isValidUrl(redirectUri)) {
      setMessage("Please enter a valid redirect URI (must start with http:// or https://)");
      setLoading(false);
      return;
    }
    if (!clientId.trim()) {
      ...
      >
        ...
        <div className="mt-8 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 text-blue-800 dark:text-blue-300 rounded-xl p-4 flex items-start gap-3">
          ...
          <div className="text-sm leading-relaxed">
            ...
            <p className="mb-2">
              <strong>Important:</strong> Make sure your redirect URL is exactly as configured in your app settings on the respective platform.
            </p>
            <p>
