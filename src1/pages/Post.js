          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="px-4 py-2 border rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#004b8f] cursor-pointer"
              />
