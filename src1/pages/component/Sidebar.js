...
import { logout, getAccessToken } from "@/utills/auth";
...
export default function Sidebar() {
  ...
  const [authData, setAuthData] = useState({ user_type: "", role_id: null });
  ...
  const navItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/socialmedia/twitter", label: "Twitter" },
        ...
        <div className="pt-4 mt-4 border-t border-gray-700">
          <div className="flex items-center px-3 py-2 text-gray-400">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-200">Welcome User!</p>
              <p className="text-xs text-gray-400">
                {authData.user_type === "admin" ? "Administrator" : "Staff"}
              </p>
            </div>
          </div>
          <button
            onClick={handleLogout}
            className="w-full flex items-center px-3 py-2 mt-2 rounded-lg text-gray-300 hover:bg-red-600 hover:text-white transition-colors duration-200"
          >
